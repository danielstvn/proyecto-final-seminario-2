                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-12 text-right" style="margin-top: -20px">
                            <a href="" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#ModalProductCreate">Agregar Producto</a>
                        </div>
                        ...
                        <form method="GET" action="{{url('/products')}}">
                            ...
                            <div class="form-row" style="margin-top: 20px">
                                <div class="form-group col-md-8">
                                   <input type="text" id="tipoFilter" name="tipoFilter"  class="form-control" placeholder="Tipo Producto" >
                                </div>
                              ...
                              <div >
                                <h2>Total Productos {{$totalProduct}}</h2>
                            </div>
                        </form>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                @if (@Auth::user()->hasRole('Administrador'))
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item modalEdit" href="#" data-toggle="modal" data-target="#ModalProductEdit{{$product['id']}}" 
                                                        >Editar</a>
                                                    </div>
                                                @endif
                                            </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                @if (@Auth::user()->hasRole('Administrador'))
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        <a class="dropdown-item  btn-danger" href="#" data-toggle="modal" data-target="#ModalProductDelete{{$product['id']}}" 
                                                        >Eliminar</a>
                                                    </div>
                                                @endif
                                            </div>
